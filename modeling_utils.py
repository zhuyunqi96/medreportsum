...
# from transformers.generation_utils import GenerationMixin # original code
from generation_utils import GenerationMixin # custom GenerationMixin for prompt_signals
