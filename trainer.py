...
class Trainer:
    ...
    def get_train_dataloader_shuffle_column(self, target_cols=[]) -> DataLoader:
        ...
        for col_name in target_cols:
            if train_dataset[col_name] is not None:
                target_col = train_dataset[col_name]
                random.shuffle(target_col)
                train_dataset = train_dataset.remove_columns(col_name).add_column(col_name, target_col)
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            ###################################
            # customed for shuffling "sampleprompt" row
            if self.args.sampleprompt is not None:
                train_dataloader = self.get_train_dataloader_shuffle_column(
                    target_cols=["sampleprompt"]
                )
            ###################################
